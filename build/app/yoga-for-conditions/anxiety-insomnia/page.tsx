...
export const metadata: Metadata = {
  title: 'Yoga for Anxiety & Insomnia Relief at Home | KayaSadhak',
  description:
    '1-on-1 therapeutic yoga at home in Delhi NCR for anxiety, stress & insomnia — Yoga Nidra, breathwork & guided meditation. Not medical advice. Enquire.',
  alternates: {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://www.kayasadhak.com/yoga-for-conditions/anxiety-insomnia',
      }
    ],
  };
